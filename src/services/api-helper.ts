import type { ContactUsData } from "./model";
import {
  getRequest,
...
export const apiHelper = {
  ...
  getServiceSuggestion: async (serviceId: string) => {
    const result = await getRequest(
      `services/mobile/${serviceId}/suggestion`,
      {}
    );
    return result;
  },
